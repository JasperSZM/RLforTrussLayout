...
from models import MLP, TanhGaussianPolicy, MakeDeterministic, TRANSFORMEREMBED
...
def get_args():
    ...
    parser.add_argument('--initial_state_files', type=str, default='best_results/MixedPoints/', help='input file for refine')
...
if __name__ == '__main__':
    ...
    if os.path.exists("{}/policy.th".format(args.save_model_path)):
